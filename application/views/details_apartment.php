			...
			<div class="col-12">
				<div class="row project_details_header_container">
					...
					<div class="col-6 text-end">
						<div class="btn-group">
							<a target="_blank" href="brochure/Elite-Villa-E-Brochure.pdf"
			...
			<div class="project-dtl-tab-row d-md-block d-none">
				...
				<div class="tab-content px-0 px-md-5" id="tab-content">
					<div role="tabpanel" class="tab-pane active" id="overview">
						<p style="text-align: justify;">Admittedly not for everyone, Villa Elite are the ultimate limited edition living experience.
					...
					<div role="tabpanel" class="tab-pane" id="specification">
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/12.png" />
									</div>
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/11.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/19.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/13.jpg" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/17.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/22.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/1.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/16.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/23.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/20.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/18.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/15.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-3 col-md-2">
										<img src="<?php echo base_url() ?>assets/images/icons/21.png" />
									</div>
									<div class="col-9 col-md-10">
										<h6 style="font-weight: 700;">DOOR FRAMES AND SHUTTERS</h6>
										<p>Frame - Shal Wood, Shutter - Flush door, Hardware - Lock, Docorative
					...
					<div role="tabpanel" class="tab-pane" id="amenities">
						<div class="row justify-content-center">
							...
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/2.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/3.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/4.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/5.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/6.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/7.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/8.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/9.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
							<div class="col-6 col-md-2 text-center">
								<div style="height: 75px; width: 115px; margin: 0 auto;">
									<img class="img-responsive"
										src="<?php echo base_url() ?>assets/images/icons/10.png" />
								</div>
								<p class="">PRIVATE CARPARKING</p>
							</div>
						</div>
