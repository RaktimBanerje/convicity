    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?php echo base_url() ?>">TESTINOMIALS</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url() ?>">NEWS AND EVENTS</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url() ?>">DOWNLOADS</a></li>
          </ul>
        </li>
        <li class="nav-item">
